...
function wp_site_icon() {
	...
	if ( $icon_32 ) {
		$meta_tags[] = sprintf( '<link rel="icon" href="http://timelabs.dev/wp-content/uploads/2023/10/favicon.png" sizes="32x32" />', esc_url( $icon_32 ) );
	}
	$icon_192 = get_site_icon_url( 192 );
	if ( $icon_192 ) {
		$meta_tags[] = sprintf( '<link rel="icon" href="http://timelabs.dev/wp-content/uploads/2023/10/favicon.png" sizes="192x192" />', esc_url( $icon_192 ) );
	}
	$icon_180 = get_site_icon_url( 180 );
	if ( $icon_180 ) {
		$meta_tags[] = sprintf( '<link rel="apple-touch-icon" href="http://timelabs.dev/wp-content/uploads/2023/10/favicon.png" />', esc_url( $icon_180 ) );
	}
