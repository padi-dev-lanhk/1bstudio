...
( function( $ ) {
    ...
    $(document).ready(function () {
        ...
        $( document ).on( 'click', '.mobile-menu .accordion-menu button.navbar-toggle', function () {
          if( $(this).hasClass("collapsed") ){
            $(".mobile-menu").removeClass("bg-black");
          }
          else{
            $(".mobile-menu").addClass("bg-black");
          }
        });
	...
	jQuery(document).ready(function() { 
          if(jQuery('.lang-japan').length > 0){
           jQuery("body" ).addClass( "japan" );
        } 
        if(jQuery('.lang-eng').length > 0){
                jQuery("body" ).addClass( "eng" );
            } 
		  if(jQuery('.blog-nav-link').length > 0){
       jQuery(".blog-nav-link").removeAttr("href");
       jQuery(".blog-nav-link").attr("href", "https://www.paditech.com/san-pham")
    } 
		  if(jQuery('body.japan .blog-nav-link').length > 0){
         jQuery(".blog-nav-link").removeAttr("href");
         jQuery(".blog-nav-link").attr("href", "https://www.paditech.com/san-pham-ja");
		jQuery(".portfolio-navigation-text").text("次の案件");
			  jQuery(".text-left .portfolio-navigation-text").text("前の案件");
      }
		  if(jQuery('.category-ban-tin').length > 0){
       jQuery(".blog-text .content a.white-space-normal").empty();
       jQuery(".blog-text .content a.white-space-normal").text("Chi tiết");
    } 
		  if(jQuery('.category-ban-tin').length > 0){
         jQuery(".pofo-single-post-title-breadcrumb-single li.text-dark-gray > a.text-dark-gray").removeAttr("href");
         jQuery(".pofo-single-post-title-breadcrumb-single li.text-dark-gray > a.text-dark-gray").attr("href", "https://www.paditech.com/ban-tin")
      } 
		  if(jQuery('.category-goc-chia-se').length > 0){
         jQuery(".pofo-single-post-title-breadcrumb-single li.text-dark-gray > a.text-dark-gray").removeAttr("href");
         jQuery(".pofo-single-post-title-breadcrumb-single li.text-dark-gray > a.text-dark-gray").attr("href", "https://www.paditech.com/chia-se/")
      }
    if(jQuery('.category-padi-life').length > 0){
         jQuery(".pofo-single-post-title-breadcrumb-single li.text-dark-gray > a.text-dark-gray").removeAttr("href");
         jQuery(".pofo-single-post-title-breadcrumb-single li.text-dark-gray > a.text-dark-gray").attr("href", "https://www.paditech.com/padi-life")
      }
		  if(jQuery('.home #blog').length > 0){
         jQuery(".home #blog a.pofo-blog-post-meta").removeAttr("href");
         jQuery(".home #blog a.pofo-blog-post-meta").attr("href", "https://www.paditech.com/ban-tin/")
      }
		  if(jQuery('body.japan').length > 0){
           jQuery(".logo-light").removeAttr("href");
           jQuery(".logo-light").attr("href", "https://www.paditech.com/ja");
           jQuery(".logo-dark").removeAttr("href");
           jQuery(".logo-dark").attr("href", "https://www.paditech.com/ja");
        } 
		  if(jQuery('.category-padi-life-ja').length > 0){
         jQuery(".japan .pofo-single-post-title-breadcrumb-single li.text-dark-gray > a.text-dark-gray").removeAttr("href");
         jQuery(".japan .pofo-single-post-title-breadcrumb-single li.text-dark-gray > a.text-dark-gray").attr("href", "https://www.paditech.com/padi-life-ja")
      }
		  if(jQuery('.category-bantin-ja').length > 0){
         jQuery(".japan .pofo-single-post-title-breadcrumb-single li.text-dark-gray > a.text-dark-gray").removeAttr("href");
         jQuery(".japan .pofo-single-post-title-breadcrumb-single li.text-dark-gray > a.text-dark-gray").attr("href", "https://www.paditech.com/ban-tin-ja")
      } 
		  if(jQuery('.japan .category-goc-chia-se-ja').length > 0){
         jQuery(".japan .pofo-single-post-title-breadcrumb-single li.text-dark-gray > a.text-dark-gray").removeAttr("href");
         jQuery(".japan .pofo-single-post-title-breadcrumb-single li.text-dark-gray > a.text-dark-gray").attr("href", "https://www.paditech.com/goc-chia-se-ja")
      } 
		  if(jQuery('.japan .search-box input').length > 0){
         jQuery(".japan .search-box input").removeAttr("placeholder");
         jQuery(".japan .search-box input").attr("placeholder", "キーワード")
      }
		  if(jQuery('.home.page-template-default').length > 0){
         jQuery("#menu-item-21906 a").removeAttr("href");
         jQuery("#menu-item-21906 a").attr("href", "https://www.paditech.com/#policy");
         jQuery("#menu-item-21904 a").removeAttr("href");
         jQuery("#menu-item-21904 a").attr("href", "https://www.paditech.com/#services");
         jQuery("#menu-item-21902 a").removeAttr("href");
        jQuery("#menu-item-21902 a").attr("href", "https://www.paditech.com/#home");
        jQuery("#menu-item-21907 a.inner-link").removeAttr("href");
        jQuery("#menu-item-21907 a.inner-link").attr("href", "https://www.paditech.com/#team");
      }
		  if(jQuery('.page-template-default.page-id-23299').length > 0){
         jQuery("#menu-item-23971 a").removeAttr("href");
         jQuery("#menu-item-23971 a").attr("href", "https://www.paditech.com/ja/#home")
         jQuery("#menu-item-23201 a").removeAttr("href");
         jQuery("#menu-item-23201 a").attr("href", "https://www.paditech.com/ja/#policy");
         jQuery("#menu-item-23200 a").removeAttr("href");
         jQuery("#menu-item-23200 a").attr("href", "https://www.paditech.com/ja/#services")
         jQuery("#menu-item-23202 a.inner-link").removeAttr("href");
         jQuery("#menu-item-23202 a.inner-link").attr("href", "https://www.paditech.com/ja/#team")
         
      }
    if( jQuery('.single-post.japan .pofo-related-posts .related-post-general-title').length > 0){
           jQuery(".single-post.japan .pofo-related-posts .related-post-general-title").text("関連記事");
        } 
    if( jQuery('.single-portfolio .blog-nav-link-prev span').length > 0){
           jQuery(".single-portfolio .blog-nav-link-prev span").text("Dự án trước");
        } 
    if( jQuery('.single-portfolio .blog-nav-link-next span').length > 0){
           jQuery(".single-portfolio .blog-nav-link-next span").text("Dự án sau");
        } 
    if( jQuery('.single-portfolio.japan .blog-nav-link-prev span').length > 0){
           jQuery(".single-portfolio.japan .blog-nav-link-prev span").text("前のプロジェクト");
        } 
        if( jQuery('.single-portfolio.japan .blog-nav-link-next span').length > 0){
           jQuery(".single-portfolio.japan .blog-nav-link-next span").text("次のプロジェクト");
        } 
