...
if( !class_exists('Pofo_Breadcrumb_Navigation') ){
	...
	/*==============================================================================
	    				=== DISPLAY BREADCRUMB ===
	  ============================================================================*/
		function pofo_display_breadcrumb() {
			...
			elseif( is_attachment() )						$swg_type = 'attachment';
			elseif ( is_page() ) 							$swg_type = 'page';			// Page
			elseif ( is_singular('portfolio') )				$swg_type = 'portfoliosinglepost';	// Single Portfolio page
			elseif ( is_single())							$swg_type = 'singlepost';	// Single post page
			elseif ( is_post_type_archive('portfolio') ) 	$swg_type = 'portfolio';
			...
			************************************************* */
			...
			case 'page':
				...
				while( 0 != $bcn_theparentid ) {
					...
					//echo print_r($mylink);
					$bcn_titlearray[$bcn_loopcount] = '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" class="text-dark-gray-2" href="' . get_permalink($bcn_theparentid) . '" title="' . $this->opt['urltitle_prefix'] . $mylink->post_title . $this->opt['urltitle_suffix'] . '"><span itemprop="name">' . $mylink->post_title . '</span><meta itemprop="position" content="'.$page_counter.'" /></a></li>';
