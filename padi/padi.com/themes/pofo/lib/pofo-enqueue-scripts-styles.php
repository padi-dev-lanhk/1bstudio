...
<?php
	...
	if( ! function_exists( 'pofo_register_style_js' ) ) :
		function pofo_register_style_js() {
			...
			wp_register_style( 'font-awesome', POFO_THEME_CSS_URI . '/font-awesome.min.css', null, '5.0.13' );
			...
			wp_localize_script( 'pofo-main', 'pofoajaxurl', array( 'ajaxurl' => admin_url( 'admin-ajax.php' ), 'theme_url' => POFO_THEME_URI, 'loading_image' => POFO_THEME_IMAGES_URI.'/spin.gif'  ) );
