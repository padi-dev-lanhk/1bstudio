    ...
    echo '<div id="' . $pofo_portfolio_id . '" class="justified-gallery justified-gallery-portfolio '.$class_list.'" data-height="'.$pofo_portfolio_archive_page_justified_height.'" data-spacing="'.$pofo_portfolio_archive_page_gap.'">';
        ...
        while ( have_posts() ) : the_post();
            ...
            ob_start();
                ...
                post_class('gallery-link '.$pofo_animation_style.$pofo_portfolio_classes_infinite_scroll);
            ...
            echo '<!-- start gallery item -->';
                ...
                echo '<a href="'.$portfolio_link.'" '.$pofo_portfolio_archive_classes.$image_lightbox_title.$image_lightbox_caption.$pofo_animation_delay_attr.$pofo_portfolio_link_target.'>';
