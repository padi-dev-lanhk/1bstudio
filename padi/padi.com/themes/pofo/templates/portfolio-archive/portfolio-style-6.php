<?php
    ...
    $img_class = $pofo_portfolio_archive_page_show_lightbox == 1 ? 'project-img-gallery' : '';
                    ...
                    echo '<div class="pofo-portfolio-archive-page-background portfolio-img bg-deep-pink position-relative text-center overflow-hidden">';
                        ...
                        echo '<div class="portfolio-icon">';
                            if( $pofo_show_internal_link == 1 ):
                                echo '<a class="text-center" href="'.$pofo_portfolio_external_link.'"'.$pofo_portfolio_link_target.'><i class="fas fa-link text-extra-dark-gray" aria-hidden="true"></i></a>';
                            endif;
                            if( $pofo_portfolio_archive_page_show_lightbox == 1 ):
                                echo '<a class="gallery-link" '.$image_lightbox_title.$image_lightbox_caption.' href="'.$image_url.'" data-group="general-portfolio"><i class="fas fa-search text-extra-dark-gray" aria-hidden="true"></i></a>';
                            endif;
                        echo '</div>';
                    echo '</div>';
