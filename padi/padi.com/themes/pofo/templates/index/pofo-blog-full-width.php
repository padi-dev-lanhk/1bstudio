                    ...
                    echo '<div class="blog-text border-all display-inline-block width-100 pofo-default-box-background-color pofo-default-post-description">';
                        echo '<div class="content padding-50px-all xs-padding-20px-all xs-text-center">';
                            ...
                            if( $pofo_show_post_title_default == 1 ){
                                echo '<a class="text-extra-dark-gray alt-font text-large font-weight-600 margin-15px-bottom display-block entry-title'.$pofo_title_dynamic_font_size.$pofo_blog_post_title_text_transform_default.'" href="'.get_permalink().'"'.$pofo_title_style_attr.'>'.get_the_title().'</a>';
                            }
                            ...
                            if( $pofo_show_button_default == 1 ){
                                echo '<a href="'.get_permalink().'" class="btn-black btn btn-very-small margin-30px-top xs-margin-20px-top white-space-normal">'.$pofo_button_text_default.'</a>';                                        
                            }
                        echo '</div>';
