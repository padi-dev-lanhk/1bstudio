                    ...
                    echo '<div class="blog-text display-inline-block width-100 pofo-blog-full-width">';
                        if( $pofo_flag == 1 ){
                            ...
                            if( $pofo_show_post_title_sticky == 1 ){
                                echo '<a class="text-extra-dark-gray alt-font text-large font-weight-600 margin-15px-bottom display-block entry-title'.$pofo_title_dynamic_font_size.$pofo_blog_post_title_text_transform_sticky.'" href="'.get_permalink().'"'.$pofo_title_style_attr.'>'.get_the_title().'</a>';
                            }
                            ...
                            if( $pofo_show_button_sticky == 1 ){
                                echo '<a href="'.get_permalink().'" class="btn-black btn btn-very-small margin-30px-top xs-margin-20px-top white-space-normal">'.$pofo_button_text_sticky.'</a>';                                        
                            }
                        echo '</div>';
