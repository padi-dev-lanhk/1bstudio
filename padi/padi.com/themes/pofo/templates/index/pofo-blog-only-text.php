                    ...
                    echo '<div class="blog-post blog-post-style7 border-all border-color-light-gray padding-fourteen-all md-padding-ten-all bg-white position-relative pofo-default-post-description xs-no-margin-bottom pofo-default-box-background-color'.$pofo_box_enable_border_default.'">';
                        echo '<div class="post-details">';
                            ...
                            if( $pofo_show_post_title_default == 1 ){
                                echo '<span class="text-large alt-font margin-50px-bottom sm-margin-30px-bottom display-block"><a href="'.get_the_permalink().'" class="entry-title'.$pofo_title_dynamic_font_size.$pofo_blog_post_title_text_transform_default.'"'.$pofo_title_style_attr.'>'.get_the_title().'</a></span>';
                            }
                            ...
                            if( $pofo_show_button_default == 1 ){
                                echo '<a href="'.get_permalink().'" class="btn-black btn btn-very-small no-margin-bottom margin-15px-top white-space-normal">'.$pofo_button_text_default.'</a>';
                            }
                        echo '</div>';
                    echo '</div>';
                echo '</div>';
