                    ...
                    echo '<div class="pofo-default-post-description">';
                        ...
                        echo '<div class="post-details display-inline-block">';
                            ...
                            if( $pofo_show_post_title_default == 1 ){
                                echo '<a class="alt-font post-title text-medium text-extra-dark-gray display-block width-90 sm-width-100 entry-title'.$pofo_title_dynamic_font_size.$pofo_blog_post_title_text_transform_default.'" href="'.get_permalink().'"'.$pofo_title_style_attr.'>'.get_the_title().'</a>';
                            }
                        echo '</div>';
                        ...
                        if( $pofo_show_button_default == 1 ){
                            echo '<a href="'.get_permalink().'" class="btn-black btn btn-very-small no-margin-bottom margin-20px-top sm-margin-15px-top white-space-normal">'.$pofo_button_text_default.'</a>';
                        }
                    echo '</div>';
                echo '</div>';
            echo '</div>';
