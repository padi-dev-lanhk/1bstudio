                        ...
                        echo '<div class="blog-post bg-light-gray inner-match-height">';
                            ...
                            echo '<div class="post-details padding-ten-all sm-padding-20px-all pofo-default-post-description pofo-default-box-background-color xs-text-center">';
                                ...
                                if( $pofo_show_post_title_default == 1 ){
                                    echo '<a class="alt-font post-title text-medium text-extra-dark-gray display-block entry-title'.$pofo_title_dynamic_font_size.$pofo_blog_post_title_text_transform_default.'" href="'.get_permalink().'"'.$pofo_title_style_attr.'>'.get_the_title().'</a>';
                                }
