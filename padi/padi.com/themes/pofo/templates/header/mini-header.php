    ...
    if( pofo_check_mini_header_enable() ) {
        ...
        echo '<div class="top-header-area bg-black padding-5px-tb'.esc_attr( $pofo_mini_header_extra_class ).'">';
            echo '<div class="'.esc_attr( $pofo_mini_header_container_style ).'">';
                echo '<div class="row">';
                    echo '<div class="col-md-6 col-sm-6 col-xs-12 alt-font xs-no-padding-lr xs-text-center">';
                    ...
                    echo '</div>';
                    echo '<div class="col-md-6 col-sm-6 col-xs-12 hidden-xs xs-no-padding-lr text-right">';
