                        ...
                        echo '<div class="display-table-cell vertical-align-middle">';
                            echo '<div class="content sm-no-padding-left ">';
                                if( $pofo_show_post_title_archive == 1 ){
                                    echo '<a class="text-extra-dark-gray margin-5px-bottom alt-font text-extra-large font-weight-600 display-inline-block entry-title'.$pofo_title_dynamic_font_size.$pofo_blog_post_title_text_transform_archive.'" href="'.get_permalink().'"'.$pofo_title_style_attr.'>'.get_the_title().'</a>';
                                }
                                ...
                                if( $pofo_show_button_archive == 1 ){
                                    echo '<a href="'.get_permalink().'" class="btn btn-very-small btn-dark-gray margin-15px-top sm-margin-15px-top white-space-normal">'.$pofo_button_text_archive.'</a>';
                                }
                            echo '</div>';
                        echo '</div>';
                    echo '</div>';
