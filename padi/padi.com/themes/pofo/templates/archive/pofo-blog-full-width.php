                ...
                echo '<div class="blog-text border-all display-inline-block width-100 pofo-box-background-color pofo-post-description">';
                    echo '<div class="content padding-50px-all xs-padding-20px-all xs-text-center">';
                        ...
                        if( $pofo_show_post_title_archive == 1 ){
                            echo '<a class="text-extra-dark-gray alt-font text-large font-weight-600 margin-15px-bottom display-block entry-title'.$pofo_title_dynamic_font_size.$pofo_blog_post_title_text_transform_archive.'" href="'.get_permalink().'"'.$pofo_title_style_attr.'>'.get_the_title().'</a>';
                        }
                        ...
                        if( $pofo_show_button_archive == 1 ){
                            echo '<a href="'.get_permalink().'" class="btn-black btn btn-very-small margin-30px-top xs-margin-20px-top white-space-normal">'.$pofo_button_text_archive.'</a>';                                        
                        }
                    echo '</div>';
                                    ...
                                    echo '<div class="display-table text-center width-100 height-100">';
                                        echo '<div class="display-table-cell vertical-align-middle'.$pofo_blog_post_meta_text_transform_archive.'">';
                                            if( $pofo_show_post_author_image_archive == 1 ) {
                                                ...
                                                echo '<img class="border-radius-100 width-30px margin-10px-right" src="'.esc_url( $author_image_url ).'" alt="">';
                                            }
