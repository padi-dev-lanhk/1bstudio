                    ...
                    echo '<div class="blog-post bg-light-gray inner-match-height">';
                        ...
                        echo '<div class="post-details padding-ten-all sm-padding-20px-all xs-text-center pofo-post-description pofo-box-background-color">';
                            ...
                            if( $pofo_show_post_title_archive == 1 ){
                                echo '<a class="alt-font post-title text-medium text-extra-dark-gray display-block entry-title'.$pofo_title_dynamic_font_size.$pofo_blog_post_title_text_transform_archive.'" href="'.get_permalink().'"'.$pofo_title_style_attr.'>'.get_the_title().'</a>';
                            }
