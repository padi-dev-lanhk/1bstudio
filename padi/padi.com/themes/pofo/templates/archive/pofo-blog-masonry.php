            ...
            echo '<div class="blog-post">';
                ...
                echo '<div class="post-details padding-ten-all bg-white sm-padding-20px-all pofo-post-description pofo-box-background-color ">';
                    ...
                    if( $pofo_show_post_title_archive == 1 ){
                        echo '<a class="alt-font post-title text-medium text-extra-dark-gray display-block margin-10px-bottom entry-title'.$pofo_title_dynamic_font_size.$pofo_blog_post_title_text_transform_archive.'" href="'.get_permalink().'"'.$pofo_title_style_attr.'>'.get_the_title().'</a>';
                    }
                    ...
                    if( $pofo_show_button_archive == 1 ){
                            echo '<a href="'.get_permalink().'" class="btn-black btn btn-very-small no-margin-bottom margin-20px-top sm-margin-15px-top white-space-normal">'.$pofo_button_text_archive.'</a>';
                    }
                echo '</div>';
            echo '</div>';
        echo '</li>';
