                ...
                echo '<div class="pofo-post-description">';
                    ...
                    echo '<div class="post-details display-inline-block">';
                        ...
                        if( $pofo_show_post_title_archive == 1 ){
                            echo '<a class="post-title text-medium text-extra-dark-gray display-block width-90 sm-width-100 entry-title'.$pofo_title_dynamic_font_size.$pofo_blog_post_title_text_transform_archive.'" href="'.get_permalink().'"'.$pofo_title_style_attr.'>'.get_the_title().'</a>';
                        }
                    echo '</div>';
