...
function pofo_custom_et_line_icon($settings, $value) {
  $css_option = vc_get_dropdown_option( $settings, $value );
  $counter_icons_list = pofo_get_et_line_icon();
...
vc_add_shortcode_param('pofo_et_line_icon', 'pofo_custom_et_line_icon');
if( !function_exists('pofo_get_et_line_icon')) {
  function pofo_get_et_line_icon() {
