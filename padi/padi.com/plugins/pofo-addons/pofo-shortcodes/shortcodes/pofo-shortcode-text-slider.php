...
if ( ! function_exists( 'pofo_text_slider_shortcode' ) ) {
    function pofo_text_slider_shortcode( $atts, $content = null ) {
        ...
        global $pofo_slider_unique_id, $pofo_featured_array, $pofo_slider_script, $text_slider_style2;
        ...
        if( !empty( $pofo_text_slides ) ) {
            ...
            switch ($text_slider_style) {
                ...
                case 'pofo-text-slider2':
                    ...
                    //Custom css start
                    $text_slider_style2 = !empty( $text_slider_style2 ) ? $text_slider_style2 : 0;
                    $text_slider_style2 = $text_slider_style2 + 1;

                    if( !empty( $pofo_button_color ) ){
                        $pofo_featured_array[] = '.text-slider-style2-'.$text_slider_style2.' a.btn { '.$pofo_button_color.' }';   
                    }
                    if( !empty( $pofo_button_hover_color ) ){
                        $pofo_featured_array[] = '.text-slider-style2-'.$text_slider_style2.' a.btn:hover { '.$pofo_button_hover_color.' }';   
                    }
                    if( !empty( $pofo_button_text_color ) ){
                        $pofo_featured_array[] = '.text-slider-style2-'.$text_slider_style2.' a.btn { '.$pofo_button_text_color.' }';   
                    }
                    if( !empty( $pofo_button_hover_text_color ) ){
                        $pofo_featured_array[] = '.text-slider-style2-'.$text_slider_style2.' a.btn:hover { '.$pofo_button_hover_text_color.' }';   
                    }
                    if( !empty( $pofo_button_border_color ) ){
                        $pofo_featured_array[] = '.text-slider-style2-'.$text_slider_style2.' a.btn { '.$pofo_button_border_color.' }';   
                    }

                    $output .='<div id="'.$pofo_slider_id.'" class="swiper-container text-center content-right-slider text-slider-style2-'.$text_slider_style2.' '.$pofo_slider_id.' '.$pofo_show_cursor_color_style.$pofo_slider_class.'">';
                        $output .='<div class="swiper-wrapper">';
                                ...
                                $output .= '<div class="swiper-slide last-paragraph-no-margin">';
                                    $output .= '<div class="padding-eighteen-all md-padding-eight-all sm-padding-thirteen-all xs-padding-15px-lr">';
                                        ...
                                        if($pofo_button_title){
                                            $output .= '<a class="btn btn-small btn-dark-gray margin-35px-top" target="'.$pofo_button_target.'" href="'.esc_url( $pofo_button_link ).'">';
