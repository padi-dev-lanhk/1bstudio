...
function pofo_post_slider_shortcode( $atts, $content = null ) {
    ...
    global $pofo_slider_parent_type, $pofo_slider_unique_id, $pofo_slider_script, $pofo_featured_array, $postslider1, $postslider2, $postslider3;
    ...
    switch ( $pofo_slider_style ) {
        ...
        case 'post-slider-style-1':
                ...
                $postslider1 = !empty( $postslider1 ) ? $postslider1 : 0;
                $postslider1 = $postslider1 + 1;

                // Title Color
                if( !empty( $pofo_title_color ) ) {
                    $pofo_featured_array[] = '.postslider1-'.$postslider1.' a.title-link { '.$pofo_title_color.' }';
                }
                if( !empty( $pofo_title_hover_color ) ) {
                    $pofo_featured_array[] = '.postslider1-'.$postslider1.' a.title-link:hover, .postslider1-'.$postslider1.' a.title-link:hover { '.$pofo_title_hover_color.' }';
                }

                // Category Color
                if( !empty( $pofo_category_color ) ) {
                    $pofo_featured_array[] = '.postslider1-'.$postslider1.' a.category-link { '.$pofo_category_color.' }';
                }
                if( !empty( $pofo_category_hover_color ) ) {
                    $pofo_featured_array[] = '.postslider1-'.$postslider1.' a.category-link:hover, .postslider1-'.$postslider1.' a.category-link:hover { '.$pofo_category_hover_color.' }';
                }

                // Button Color
                if( !empty( $pofo_button_color ) ){
                    $pofo_featured_array[] = '.postslider1-'.$postslider1.' a.btn { '.$pofo_button_color.' }';   
                }
                if( !empty( $pofo_button_hover_color ) ){
                    $pofo_featured_array[] = '.postslider1-'.$postslider1.' a.btn:hover, .postslider1-'.$postslider1.' a.btn:focus { '.$pofo_button_hover_color.' }';   
                }
                if( !empty( $pofo_button_text_color ) ){
                    $pofo_featured_array[] = '.postslider1-'.$postslider1.' a.btn { '.$pofo_button_text_color.' }';   
                }
                if( !empty( $pofo_button_hover_text_color ) ){
                    $pofo_featured_array[] = '.postslider1-'.$postslider1.' a.btn:hover, .postslider1-'.$postslider1.' a.btn:focus { '.$pofo_button_hover_text_color.' }';   
                }
                if( !empty( $pofo_button_border_color ) ){
                    $pofo_featured_array[] = '.postslider1-'.$postslider1.' a.btn { '.$pofo_button_border_color.' }';   
                }

                $output .= '<div id="'.$pofo_slider_id.'" class="swiper-container width-100 postslider1-'.$postslider1.' '.$pofo_slider_id.' '.$pofo_slider_class.$show_cursor_color_style.'">
            ...
            case 'post-slider-style-2':
                ...
                $postslider2 = !empty( $postslider2 ) ? $postslider2 : 0;
                $postslider2 = $postslider2 + 1;

                // Title Color
                if( !empty( $pofo_title_color ) ) {
                    $pofo_featured_array[] = '.postslider2-'.$postslider2.' a.title-link { '.$pofo_title_color.' }';
                }
                if( !empty( $pofo_title_hover_color ) ) {
                    $pofo_featured_array[] = '.postslider2-'.$postslider2.' a.title-link:hover, .postslider2-'.$postslider2.' a.title-link:hover { '.$pofo_title_hover_color.' }';
                }

                // Category Color
                if( !empty( $pofo_category_color ) ) {
                    $pofo_featured_array[] = '.postslider2-'.$postslider2.' a.category-link { '.$pofo_category_color.' }';
                }
                if( !empty( $pofo_category_hover_color ) ) {
                    $pofo_featured_array[] = '.postslider2-'.$postslider2.' a.category-link:hover, .postslider2-'.$postslider2.' a.category-link:hover { '.$pofo_category_hover_color.' }';
                }

                // Button Color
                if( !empty( $pofo_button_color ) ){
                    $pofo_featured_array[] = '.postslider2-'.$postslider2.' a.btn { '.$pofo_button_color.' }';   
                }
                if( !empty( $pofo_button_hover_color ) ){
                    $pofo_featured_array[] = '.postslider2-'.$postslider2.' a.btn:hover, .postslider2-'.$postslider2.' a.btn:focus { '.$pofo_button_hover_color.' }';   
                }
                if( !empty( $pofo_button_text_color ) ){
                    $pofo_featured_array[] = '.postslider2-'.$postslider2.' a.btn { '.$pofo_button_text_color.' }';   
                }
                if( !empty( $pofo_button_hover_text_color ) ){
                    $pofo_featured_array[] = '.postslider2-'.$postslider2.' a.btn:hover, .postslider2-'.$postslider2.' a.btn:focus { '.$pofo_button_hover_text_color.' }';   
                }
                if( !empty( $pofo_button_border_color ) ){
                    $pofo_featured_array[] = '.postslider2-'.$postslider2.' a.btn { '.$pofo_button_border_color.' }';   
                }

                $output .= '<div id="'.$pofo_slider_id.'" class="swiper-container swiper-blog white-move postslider2-'.$postslider2.' '.$pofo_slider_id.' '.$pofo_slider_class.$show_cursor_color_style.'">
                                <div class="swiper-wrapper">';
            ...
            case 'post-slider-style-3':
                ...
                $postslider3 = !empty( $postslider3 ) ? $postslider3 : 0;
                $postslider3 = $postslider3 + 1;

                // Title Color
                if( !empty( $pofo_title_color ) ) {
                    $pofo_featured_array[] = '.postslider3-'.$postslider3.' a.title-link { '.$pofo_title_color.' }';
                }
                if( !empty( $pofo_title_hover_color ) ) {
                    $pofo_featured_array[] = '.postslider3-'.$postslider3.' a.title-link:hover, .postslider3-'.$postslider3.' a.title-link:hover { '.$pofo_title_hover_color.' }';
                }

                // Category Color
                if( !empty( $pofo_category_color ) ) {
                    $pofo_featured_array[] = '.postslider3-'.$postslider3.' a.category-link { '.$pofo_category_color.' }';
                }
                if( !empty( $pofo_category_hover_color ) ) {
                    $pofo_featured_array[] = '.postslider3-'.$postslider3.' a.category-link:hover, .postslider3-'.$postslider3.' a.category-link:hover { '.$pofo_category_hover_color.' }';
                }

                // Button Color
                if( !empty( $pofo_button_color ) ){
                    $pofo_featured_array[] = '.postslider3-'.$postslider3.' a.btn { '.$pofo_button_color.' }';   
                }
                if( !empty( $pofo_button_hover_color ) ){
                    $pofo_featured_array[] = '.postslider3-'.$postslider3.' a.btn:hover, .postslider3-'.$postslider3.' a.btn:focus { '.$pofo_button_hover_color.' }';   
                }
                if( !empty( $pofo_button_text_color ) ){
                    $pofo_featured_array[] = '.postslider3-'.$postslider3.' a.btn { '.$pofo_button_text_color.' }';   
                }
                if( !empty( $pofo_button_hover_text_color ) ){
                    $pofo_featured_array[] = '.postslider3-'.$postslider3.' a.btn:hover, .postslider3-'.$postslider3.' a.btn:focus { '.$pofo_button_hover_text_color.' }';   
                }
                if( !empty( $pofo_button_border_color ) ){
                    $pofo_featured_array[] = '.postslider3-'.$postslider3.' a.btn { '.$pofo_button_border_color.' }';   
                }
                ...
                if( !empty( $post_posts->post_count ) && $post_posts->post_count > 0 ) {
                    ...
                    $pofo_featured_array[] = '.postslider3-'.$postslider3.' li { width: ' . $slide_width . '%; }';
                    $pofo_featured_array[] = '.postslider3-'.$postslider3.' li.blog-column-active { width: ' . $active_slide_width . '%; }';
                }

                $cnt = 0;
                $output .= ' <ul id="'.$pofo_slider_id.'" class="blog-header-style1 equalize sm-equalize-auto postslider3-'.$postslider3.' '.$pofo_slider_id.' '.$pofo_slider_class.'">';
