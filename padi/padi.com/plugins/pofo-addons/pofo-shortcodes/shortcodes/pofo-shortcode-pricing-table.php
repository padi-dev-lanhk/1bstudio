...
if ( ! function_exists( 'pofo_pricing_table_shortcode' ) ) {
    function pofo_pricing_table_shortcode( $atts, $content = null ) {
        ...
        global $pofo_featured_array, $pricing1, $pricing2;
        ...
        switch ( $pofo_pricing_style ) {
            ...
            case 'pricing-style-1':
                ...
                if( !empty( $pofo_button_bg_color ) || !empty( $pofo_button_text_color ) || !empty( $pofo_button_border_color ) ){
                    $pofo_featured_array[] = '.pricing1-'.$pricing1.' .pricing-action a.btn { '.$pofo_button_bg_color.$pofo_button_text_color.$pofo_button_border_color.' }';
                }
                if( !empty( $pofo_button_hover_bg_color ) || !empty( $pofo_button_hover_text_color ) ){
                    $pofo_featured_array[] = '.pricing1-'.$pricing1.' .pricing-action a.btn:hover { '.$pofo_button_hover_bg_color.$pofo_button_hover_text_color.' }';
                }

                $pofo_price_element_tag = !empty( $pofo_price_element_tag ) ? $pofo_price_element_tag : 'h4';

                $output .= '<div'.$id.' class="'.$class_list.' pricing-box border-all border-width-1 border-color-extra-light-gray overflow-hidden pricing1-'.$pricing1.'"'.$pofo_box_style.'>';
                    $output .= '<div class="padding-55px-all bg-very-light-gray sm-padding-30px-all xs-padding-40px-all"'.$pofo_top_box_background_color.'>';
                        if( $custom_icon == 1 && !empty( $custom_icon_image ) ) {
                            $output .= '<div class="pricing-title">';
                                $output .= '<img src="'.esc_url( $custom_icon_image ).'"'.$icon_image_alt.$icon_image_title.' class="text-deep-pink display-inline-block padding-30px-all bg-white box-shadow-light border-radius-100 margin-25px-bottom"'.$pofo_icon_style.' />';
                            $output .= '</div>';
                    ...
                    $output .= '<div class="padding-45px-all pricing-features sm-padding-20px-all xs-padding-30px-all"'.$pofo_bottom_box_background_color.'>';
                        ...
                        if( !empty( $pofo_button_title ) ) {
                            $output .= '<div class="pricing-action margin-35px-top sm-no-margin-top">';
                                $output .= '<a '.$id.' href="'.$pofo_button_link.'" target="'.$pofo_button_target.'" class="btn btn-dark-gray btn-small text-extra-small">'.$pofo_button_title.'</a>';
                            $output .= '</div>';
                        }
                    $output .= '</div>';
                $output .= '</div>';
            ...
            case 'pricing-style-2':
                ...
                if( !empty( $pofo_button_bg_color ) || !empty( $pofo_button_text_color ) || !empty( $pofo_button_border_color ) ){
                    $pofo_featured_array[] = '.pricing2-'.$pricing2.' .pricing-action a.btn { '.$pofo_button_bg_color.$pofo_button_text_color.$pofo_button_border_color.' }';
                }
                if( !empty( $pofo_button_hover_bg_color ) || !empty( $pofo_button_hover_text_color ) ){
                    $pofo_featured_array[] = '.pricing2-'.$pricing2.' .pricing-action a.btn:hover { '.$pofo_button_hover_bg_color.$pofo_button_hover_text_color.' }';
                }

                $pofo_price_element_tag = !empty( $pofo_price_element_tag ) ? $pofo_price_element_tag : 'h4';

                $output .= '<div'.$id.' class="'.$class_list.' pricing-box border-all border-width-1 border-color-extra-light-gray bg-white pricing2-'.$pricing2.'"'.$pofo_box_style.'>';
                    if( $sale_type ){
                    ...
                    $output .= '<div class="padding-30px-all pricing-features sm-padding-20px-all xs-padding-30px-all"'.$pofo_bottom_box_background_color.'>';
                        ...
                        if( !empty( $pofo_button_title ) ) {
                            $output .= '<div class="pricing-action margin-35px-top sm-no-margin-top">';
                                $output .= '<a '.$id.' href="'.$pofo_button_link.'" target="'.$pofo_button_target.'" class="btn btn-transparent-dark-gray btn-very-small text-extra-small">'.$pofo_button_title.'</a>';
                            $output .= '</div>';
                        }
                    $output .= '</div>';
                $output .= '</div>';
