    ...
    static function init()
    {
        ...
        if (is_admin()) {
            ...
            if($options['captcha_show_woo_registration']){
                ...
                add_action( 'woocommerce_register_post', array('WPCaptcha_Functions', 'check_woo_register_form'), 10, 3 );
            }

            // Handle woocommerce checkout
            if($options['captcha_show_woo_checkout']){
                add_filter( 'woocommerce_review_order_before_submit', array('WPCaptcha_Functions', 'captcha_fields'));
            ...
            add_filter('authenticate', array('WPCaptcha_Functions', 'wp_authenticate_username_password'), 20, 3);
