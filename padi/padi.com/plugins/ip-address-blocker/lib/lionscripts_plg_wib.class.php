										...
										if(isset($blocked_ips_list) && !empty($blocked_ips_list))
										{
											...
											?>
												<tr id="blocked_ip_<?php echo $ip_data->id; ?>" class="blocked_ips_data">
													...
													<td class="tcenter"><a title="Delete IP <?php echo $ip_data; ?>" href="admin.php?page=<?php echo $this->site_admin_url_val; ?>&delete_ip=<?php echo $key; ?>" onClick="return confirm('Are you sure you want to delete the IP Address <?php echo $ip_data; ?> from the Blocking List?');"><img src="<?php echo $this->plg_images['www']."icon-delete-16.png"; ?>"/></a></td>
												</tr>
												<?php 
												$i++;
											}
